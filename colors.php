...
<body>
	<div>
		<img src = "images/b.jpg" style ="width: 400px; height:  400x; margin-left: 140px; margin-top: 90px; border: 2px solid black; " >
	<p style="margin-left: 600px; margin-top: -332px; padding-top: -120px; margin-bottom: -20px; font-size: 30px;">COLOR COLLECTIONS</p>
