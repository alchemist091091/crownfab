...
<body>
	<div>
		<img src = "images/1.jpg" style ="width: 400px; height:  400x; margin-left: 140px; margin-top: 90px; border: 2px solid black; " >
	<p style="margin-left: 600px; margin-top: -410px; padding-top: -120px; margin-bottom: -20px; font-size: 30px;">HOODIE COLLECTIONS</p>
	...
	<p style="margin-left: 600px; margin-top: px; font-size: 15px; margin-top: 15px;">Colors:</p>
	<select style="margin-left: 600px;margin-top: 10px; width: 500px; height: 40px; border: 1px solid black;box-shadow: 0 5px 10px rgba(0,0,0,0.1); ">
		<option value="Small">Select a Color</option>
		<option value="Small">Red</option>
  		<option value="Medium">Orange</option>
	 	 <option value="Large">Yellow</option>
	 	 <option value="Small">Khaki</option>
  		<option value="Medium">Cream</option>
